...
var widget_wind_direction = $.extend({}, widget_volume, {
    ...
    init: function () {
        ...
        this.elements.each(function(index) {
            ...
            elem.data('direction', $(this).data('direction') || $(this).data('get') || 'wind_direction');
            elem.data('speed', $(this).data('speed') || 'wind_speed');
            elem.addReading('direction');
            elem.addReading('speed');
